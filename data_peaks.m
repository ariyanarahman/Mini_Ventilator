...
ax = uiaxes(fig, 'Position', [50 120 900 450], FontSize= 25);
hold(ax, 'on');

%plot(ax, time_s, p1, 'r', 'DisplayName', 'P1', 'LineWidth', 2);
%plot(ax, time_s, p2, 'b', 'DisplayName', 'P2', 'LineWidth', 2);
plot(ax, time_s, dp, 'g', 'DisplayName', 'DeltaP', 'LineWidth',6);
...
scatter(ax, time_s(dp_locs(1:n_breaths)), dp_v, 60, 'black', 'x', 'LineWidth', 7, 'HandleVisibility', 'off');

ylabel(ax, 'Pressure (cmH2O)', 'FontSize', 25); xlabel(ax, 'Time (seconds)', FontSize=25);
